# Calorie Converter Requirements Document\n
## 1. Tool Name
Calorie Converter\n
## 2. Tool Description
A simple and efficient tool that allows users to quickly look up the calorie content of various foods by entering the food name or uploading a photo of the food.

## 3. Core Features
\n### 3.1 Food Name Input
- Provide a text input field for users to enter the name of the food
- Support common food names and ingredients
\n### 3.2 Photo Upload and Recognition
- Provide an image upload button for users to take a photo or upload an existing image of food
- Automatically recognize the food item from the uploaded photo
- Display the identified food name and its calorie content
